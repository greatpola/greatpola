<div align="center">
  <img src="./assets/banner.png?v=2" alt="Agent 8" width="100%" />
</div>
...
스타트업의 병목은 명확했습니다. 개발자를 구하고, 디자이너를 설득하고, 마케터와 일정을 맞추는 데 한 달이 걸렸습니다. 아이디어는 있는데 만들 사람이 없고, 만들 수 있는 사람은 이미 다른 프로젝트에 묶여 있었습니다.
